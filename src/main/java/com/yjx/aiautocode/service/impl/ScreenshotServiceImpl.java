...
import com.yjx.aiautocode.mannager.CosManager;
import com.yjx.aiautocode.service.ScreenshotService;
import com.yjx.aiautocode.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    private String uploadScreenshotToCos(String localScreenshotPath) {
        ...
        // 生成 COS 对象键
        String fileName = UUID.randomUUID().toString().substring(0, 8) + "_compressed.jpg";//uuid截取9位
